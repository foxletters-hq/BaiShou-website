...
const ja: Messages = {
  ...
  faq: {
    eyebrow: 'FAQ',
    title: 'よくある質問',
    lead: '白守についての質問、知りたいことがここにあります。',
    items: {
      free: {
        q: '白守は無料ですか？',
        a: '白守のコア機能は完全に無料でオープンソースです。ローカル日記、ファイル管理、自前同期、カスタムモデル API は開放。公式の暗号化同期・バックアップ・AI サービスは任意で、無料でもデータの所有と移行は続けられます。',
      },
      privacy: {
        q: 'データはどこに保存されますか？プライバシーは？',
        a: '白守はローカル優先アーキテクチャです。コアデータはデフォルトでデバイスに保存され、インポート・エクスポートに対応。公式の暗号化同期、自前の S3 / WebDAV、完全オフラインのいずれも選べます。データがプラットフォームに閉じ込められることはありません。',
      },
      platform: {
        q: '対応プラットフォームは？',
        a: '現在 Windows と Android に対応し、マルチデバイス同期をサポートします。最新版はダウンロードページまたは GitHub Releases から取得できます。',
      },
      diff: {
        q: 'Notion や Obsidian との違いは？',
        a: 'ノートツールは記録と整理を解決し、白守は個人データを AI が理解し長く使うことを解決します。コンパニオン、RAG、長期記憶は土台設計で、後付けプラグインではありません。AI が蓄積した個人記憶を検索・質問応答・要約できます。',
      },
      model: {
        q: 'カスタム AI モデルを使えますか？',
        a: 'はい。カスタムモデル API に接続でき、国産大モデルも含みます。白守は AI 能力を単一プロバイダーに縛りません。',
      },
      migrate: {
        q: 'データをエクスポートできますか？',
        a: 'はい。白守はインポート・エクスポートに対応し、日記・ファイル・記憶がプラットフォームに閉じ込められません。公式サービスを止めても、データの所有と移行は続けられます。',
      },
    },
  },
  community: {
